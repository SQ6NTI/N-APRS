...
#define DEFAULT_LORA_FREQ 433.775       /* Default LoRa frequency in MHz */
#define DEFAULT_LORA_BW 125             /* Default LoRa bandwidth in kHz */
#define DEFAULT_LORA_SF 9               /* Default LoRa spreading factor (SF) */
#define DEFAULT_LORA_CR 7               /* Default LoRa coding rate (CR) */
